  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-temple-900/90 border border-temple-800 p-6 rounded-3xl shadow-xl">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="bg-temple-800 border border-temple-700 rounded-xl px-3 py-2 text-xs text-temple-200 focus:outline-none"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {/* Tithi */}
        <div className="bg-temple-900/90 border border-saffron-500/30 rounded-2xl p-5 shadow-lg space-y-2">
          ...
          <p className="text-lg font-black text-saffron-400">Ekadashi</p>
          <p className="text-xs text-temple-300">Shukla Paksha (Upto 08:42 PM)</p>
          <p className="text-[10px] text-saffron-200/80 font-mono">Deity: Lord Vishnu</p>
        </div>
        ...
        <div className="bg-temple-900/90 border border-saffron-500/30 rounded-2xl p-5 shadow-lg space-y-2">
          ...
          <p className="text-lg font-black text-saffron-400">Somavaara</p>
          <p className="text-xs text-temple-300">Monday (Chandravara)</p>
          <p className="text-[10px] text-saffron-200/80 font-mono">Planet: Chandra (Moon)</p>
        </div>
        ...
        <div className="bg-temple-900/90 border border-saffron-500/30 rounded-2xl p-5 shadow-lg space-y-2">
          ...
          <p className="text-lg font-black text-saffron-400">Rohini</p>
          <p className="text-xs text-temple-300">Upto 11:15 PM</p>
          <p className="text-[10px] text-saffron-200/80 font-mono">Lord: Prajapati Brahma</p>
        </div>
        ...
        <div className="bg-temple-900/90 border border-saffron-500/30 rounded-2xl p-5 shadow-lg space-y-2">
          ...
          <p className="text-lg font-black text-saffron-400">Harshana</p>
          <p className="text-xs text-temple-300">Auspicious Yoga</p>
          <p className="text-[10px] text-saffron-200/80 font-mono">Effect: Bliss & Victory</p>
        </div>
        ...
        <div className="bg-temple-900/90 border border-saffron-500/30 rounded-2xl p-5 shadow-lg space-y-2">
          ...
          <p className="text-lg font-black text-saffron-400">Vanija</p>
          <p className="text-xs text-temple-300">Upto 09:12 AM, then Vishti</p>
          <p className="text-[10px] text-saffron-200/80 font-mono">Lord: Manibhadra</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Shubh Muhurats */}
        <div className="bg-temple-900/90 border border-emerald-500/40 rounded-3xl p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-temple-800">
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-emerald-400" />
              <h3 className="font-black text-sm text-temple-100 uppercase tracking-wider">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 rounded-xl bg-temple-950/60 border border-temple-800 flex items-center justify-between">
              <div>
                <p className="font-bold text-temple-100">Abhijit Muhurat (Highest Merit)</p>
                <p className="text-[11px] text-temple-400">Ideal for Sankalp, Initiation & Purchase</p>
              </div>
            ...
            <div className="p-3 rounded-xl bg-temple-950/60 border border-temple-800 flex items-center justify-between">
              <div>
                <p className="font-bold text-temple-100">Brahma Muhurat (Meditation & Japa)</p>
                <p className="text-[11px] text-temple-400">Vedic chanting & Sadhana</p>
              </div>
            ...
            <div className="p-3 rounded-xl bg-temple-950/60 border border-temple-800 flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-temple-400">Auspicious start of new journey</p>
              </div>
        ...
        {/* Ashubh Muhurats */}
        <div className="bg-temple-900/90 border border-rose-500/40 rounded-3xl p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-temple-800">
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 rounded-xl bg-temple-950/60 border border-temple-800 flex items-center justify-between">
              <div>
                <p className="font-bold text-temple-100">Rahu Kaal (Inauspicious)</p>
                <p className="text-[11px] text-temple-400">Avoid signing contracts or traveling</p>
              </div>
            ...
            <div className="p-3 rounded-xl bg-temple-950/60 border border-temple-800 flex items-center justify-between">
              <div>
                <p className="font-bold text-temple-100">Yamaganda Kaal</p>
                <p className="text-[11px] text-temple-400">Avoid financial transactions</p>
              </div>
            ...
            <div className="p-3 rounded-xl bg-temple-950/60 border border-temple-800 flex items-center justify-between">
              <div>
                <p className="font-bold text-temple-100">Gulika Kaal</p>
                <p className="text-[11px] text-temple-400">Saturn period</p>
              </div>
