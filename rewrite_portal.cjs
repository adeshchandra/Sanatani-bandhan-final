...
import { 
  ...
  Lock, ArrowLeft, AlertTriangle, MapPin, AlignLeft, Languages, 
                ...
                >
                  ...
                  <div className="bg-stone-50/50 p-5 rounded-2xl border border-stone-200 space-y-4">
                    ...
                    <div className="bg-white p-4 rounded-xl border border-stone-200 shadow-sm space-y-4">
                       ...
                       <div>
                         ...
                         <div className="relative group">
                           <Globe2 size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-stone-400 group-focus-within:text-amber-500" />
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <AlignLeft size={16} className="absolute left-3 top-3.5 text-stone-400 group-focus-within:text-amber-500" />
                  ...
                  <div className="bg-stone-50/50 p-5 rounded-2xl border border-stone-200 space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <Mail size={16} className="absolute left-3 top-3.5 text-stone-400 group-focus-within:text-amber-500" />
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <Lock size={16} className="absolute left-3 top-3.5 text-stone-400 group-focus-within:text-amber-500" />
