...
workspaceRegistry['AkshayaPatra'] = workspaceRegistry['Trust'];
workspaceRegistry['KashiKshetra'] = workspaceRegistry['Tirth'];
workspaceRegistry['DharmadaTrust'] = workspaceRegistry['Trust'];
workspaceRegistry['MahotsavSamiti'] = workspaceRegistry['Samaj'];
workspaceRegistry['PurohitSabha'] = workspaceRegistry['Mandir'];
